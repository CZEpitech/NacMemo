                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="{{__('Name')}}" value="{{ !empty(old('name')) ? old('name') : $category->name }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="3">{{ !empty(old('description')) ? old('description') : $category->description }}</textarea>
