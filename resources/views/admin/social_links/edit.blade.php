            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <span class="card-subtitle">
                        {{ __('Modify details of the social media link.') }}
                    </span>
                </div>
                <!-- Page title actions -->
                                        ...
                                        <fieldset class="form-fieldset">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="{{ __('Enter Font Awesome icon class, e.g., fa-facebook') }}"
                                                    value="{{ old('icon', $socialLink->icon) }}">
                                                <small
                                                    class="form-hint">{{ __('Example: fa-facebook for Facebook') }}</small>
                                                @error('icon')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
