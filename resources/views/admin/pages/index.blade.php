                    ...
                    <tbody>
                        @foreach ($pages as $page)
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" onclick="updateStatusPost({{ $page->id }}, 'page')"
                                        class="text-decoration-none" id="status-post-{{ $page->id }}">
                                        <span id="status-post-{{ $page->id }}">
                                            @if ($page->getStatus())
                                    ...
                                    <span class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" target="_blank"
                                                href="{{ route('page.show', [$page->id, $page->slug]) }}">
