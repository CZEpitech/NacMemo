                    ...
                    <form action="{{ route('admin.blog.posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card card-md rounded-3 shadow">
                            <div class="card-body">
                                ...
                                <div class="mb-3 blog-desc">
                                    <label class="form-label required">{{ __('Body') }}</label>
                                    <textarea class="form-control custom-file-input @error('body') is-invalid @enderror" id="editorbody" cols="5"
                                        name="body" rows="15">{{ old('body') }}</textarea>
                                    <small class="form-hint">{{ __('app.form_hint_textarea_insert') }}</small>
                                    @error('body')
