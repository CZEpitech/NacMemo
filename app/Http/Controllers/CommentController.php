...
class CommentController extends Controller
{
    ...
    public function store(Request $request, $item_id)
    {
        ...
        if ($comment) {
            ...
            // Vérifier si le propriétaire de l'item a activé les notifications
            $itemOwner = $item->user; // Assurez-vous que l'item a une relation avec l'utilisateur
    
            if ($itemOwner && $itemOwner->notification_comment) {
                // Envoyer une notification ou un email
                $itemOwner->notify(new \App\Notifications\CommentNotification($comment));
            }
